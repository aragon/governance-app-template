                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <Link href="/" className={`block py-2 pr-4 pl-3 rounded lg:p-0 dark:text-white ${!segment ? 'text-primary-300' : 'text-primary-50'}`} aria-current="page">Home</Link>
                            </li>
                            <li>
                                <Link href="/proposals" className={`block py-2 pr-4 pl-3 rounded lg:p-0 dark:text-white ${segment === 'proposals' ? 'text-primary-300' : 'text-primary-50'}`} aria-current="page">Proposals</Link>
                            </li>
                            <li>
