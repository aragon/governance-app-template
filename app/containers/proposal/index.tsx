  ...
  return (
    <section className="pb-6 pt-10 lg:pb-[15px] lg:pt-[20px] w-full">
      <Link
        ...
        className="bg-neutral-50 flex justify-between rounded-xl border border-stroke border-neutral-200 shadow-md px-4 py-5 xs:px-10 md:px-6 lg:px-7 cursor-pointer"
      >
        <div className="">
