...
import { OptimisticTokenVotingPluginAbi } from "@/app/plugins/lock-to-vote/artifacts/OptimisticTokenVotingPlugin.sol";
import {
  Proposal,
  VetoCastEvent,
  VoteCastResponse,
} from "@/app/plugins/lock-to-vote/utils/types";
