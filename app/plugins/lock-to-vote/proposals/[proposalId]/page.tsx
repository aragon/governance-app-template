...
import { useProposal } from "@/app/plugins/lock-to-vote/hooks/useProposal";
import { ToggleGroup, Toggle } from "@aragon/ods";
import ProposalDescription from "@/app/plugins/lock-to-vote/components/proposal/description";
import VetoesSection from "../../components/vote/vetoes-section";
import ProposalHeader from "@/app/plugins/lock-to-vote/components/proposal/header";
import VetoTally from "@/app/plugins/lock-to-vote/components/vote/tally";
import ProposalDetails from "@/app/plugins/lock-to-vote/components/proposal/details";
import { Else, If, Then } from "@/components/if";
import { PleaseWaitSpinner } from "@/components/please-wait";
import { useState } from "react";
import { useProposalVeto } from "@/app/plugins/lock-to-vote/hooks/useProposalVeto";
import { useProposalExecute } from "@/app/plugins/lock-to-vote/hooks/useProposalExecute";
import { useProposalClaimLock } from "@/app/plugins/lock-to-vote/hooks/useProposalClaimLock";
