...
import { useProposalVoteList } from "@/plugins/toucanVoting/hooks/useProposalVoteList";
import { ToggleGroup, Toggle } from "@aragon/ods";
import ProposalDescription from "@/plugins/toucanVoting/components/proposal/description";
import VotesSection from "@/plugins/toucanVoting/components/vote/votes-section";
import ProposalHeader from "@/plugins/toucanVoting/components/proposal/header";
import { formatUnits } from "viem";
import { useUserCanVote } from "@/plugins/toucanVoting/hooks/useUserCanVote";
import VoteTally from "@/plugins/toucanVoting/components/vote/tally";
import VotingModal from "@/plugins/toucanVoting/components/vote/voting-modal";
import ProposalDetails from "@/plugins/toucanVoting/components/proposal/details";
